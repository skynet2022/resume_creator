...
[![GitHub last commit](https://img.shields.io/github/last-commit/skynet2022/resume_creator?style=flat-square&color=f59e0b)](https://github.com/skynet2022/resume_creator)
...
### 📖 معرفی
این پروژه یک **رزومه‌ساز تعاملی تک‌صفحه‌ای (Single Page)** است که با استفاده از **HTML، CSS و جاوااسکریپت خالص** نوشته شده و نیازی به سرور یا فریم‌ورک خاصی ندارد.  
با کلیک روی هر بخش از صفحه، می‌توانید آن را **به‌صورت زنده ویرایش** کنید و در نهایت با یک کلیک، خروجی **PDF با کیفیت چاپ A4** دریافت نمایید.
...
<!-- ======================== English ======================== -->
<details>
<summary><b>🇬🇧 English — Interactive Multi-Language Resume Builder</b></summary>
<br>

### 📖 Introduction
This project is an **interactive single-page resume builder** built with **pure HTML, CSS, and JavaScript** — no server or framework required.  
Click on any section to **edit it live**, and with one click, export a **high-quality A4 PDF**.
...
### 📖 مقدمة
هذا المشروع هو **منشئ سيرة ذاتية تفاعلي بصفحة واحدة** مكتوب بـ **HTML و CSS و JavaScript الخالص** — لا يحتاج إلى خادم أو إطار عمل.  
انقر على أي قسم **لتعديله مباشرة**، وبضغطة واحدة احصل على **ملف PDF بجودة A4**.
...
<!-- ======================== Русский ======================== -->
<details>
<summary><b>🇷🇺 Русский — Интерактивный конструктор резюме на 8 языках</b></summary>
<br>

### 📖 Введение
Этот проект — **интерактивный одностраничный конструктор резюме**, написанный на **чистом HTML, CSS и JavaScript** — не требует сервера или фреймворка.  
Нажмите на любой раздел, чтобы **редактировать его в реальном времени**, и одним кликом получите **PDF формата A4**.
...
<!-- ======================== 中文 ======================== -->
<details>
<summary><b>🇨🇳 中文 — 交互式多语言简历生成器</b></summary>
<br>

### 📖 简介
这是一个**交互式单页简历生成器**，使用**纯 HTML、CSS 和 JavaScript** 构建 — 无需服务器或框架。  
点击任何部分即可**实时编辑**，一键生成**高质量 A4 PDF**。
...
<!-- ======================== Español ======================== -->
<details>
<summary><b>🇪🇸 Español — Creador de Currículum Interactivo Multilingüe</b></summary>
<br>

### 📖 Introducción
Este proyecto es un **creador de currículum interactivo de una sola página** construido con **HTML, CSS y JavaScript puro** — no necesita servidor ni framework.  
Haz clic en cualquier sección para **editarla en vivo** y, con un clic, obtén un **PDF de calidad A4**.
...
<!-- ======================== Deutsch ======================== -->
<details>
<summary><b>🇩🇪 Deutsch — Interaktiver Mehrsprachiger Lebenslauf-Ersteller</b></summary>
<br>

### 📖 Einführung
Dieses Projekt ist ein **interaktiver einseitiger Lebenslauf-Ersteller**, der mit **reinem HTML, CSS und JavaScript** entwickelt wurde — kein Server oder Framework erforderlich.  
Klicken Sie auf einen beliebigen Abschnitt, um ihn **live zu bearbeiten**, und mit einem Klick erhalten Sie ein **hochwertiges A4-PDF**.
...
<!-- ======================== हिन्दी ======================== -->
<details>
<summary><b>🇮🇳 हिन्दी — इंटरैक्टिव बहुभाषी रिज्यूमे निर्माता</b></summary>
<br>

### 📖 परिचय
यह प्रोजेक्ट एक **इंटरैक्टिव सिंगल-पेज रिज्यूमे बिल्डर** है, जो **शुद्ध HTML, CSS और JavaScript** में लिखा गया है — इसे सर्वर या फ्रेमवर्क की आवश्यकता नहीं है।  
किसी भी सेक्शन पर क्लिक करें और **लाइव एडिट** करें, और एक क्लिक में **उच्च-गुणवत्ता वाला A4 PDF** प्राप्त करें।
...
- ارسال Pull Request
- پیشنهاد ترجمه‌های جدید

</div>

If you have ideas for improvements, bug fixes, or new languages, we'd love your contributions.  
**Ways to contribute:**
